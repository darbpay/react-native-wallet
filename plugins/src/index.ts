...
const EXTENSION_DEFAULTS = {
  ...
  // `com.apple.PassKit.issuer-provisioning.authorization` — not generated by
  // this plugin (we only ship the Non-UI extension).
...
export default createRunOncePlugin(withReactNativeWallet, 'ReactNativeWallet', '0.2.11');
